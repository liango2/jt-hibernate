...
//        DriverManager.registerDriver(new com.mysql.jdbc.Driver());
    ...
    public void saveCustomer(Customer customer) throws Exception {
        ...
        try {
            ...
            if (customer.getName() == null){
                throw new BusinessException("customer name can not be null");
            }
            ...
            while (iterator.hasNext()) {
                ...
                if (order.getOrderNumber() == null)
                    throw new BusinessException("order number can not be null");
    ...
    public Customer loadCustomer(long customerId) throws Exception {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                throw new BusinessException("OID:" + customerId +
                        "'s Customer Object is not exist!!!");
            }
    ...
    public List findCustomerByName(String name) throws Exception {
        System.out.println("执行方法：findCustomerByName");
